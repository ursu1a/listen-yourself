...
export const Achievements = () => {
  ...
  return (
    <article>
      <ul className="flex flex-col justify-center w-full lg:flex-row bg-secondary transform scale-75 opacity-0 animate-block-in py-2 lg:py-6 rounded-xl lg:rounded-3xl divide-y divide-default-400 lg:divide-y-0">
        {data.map((item, index) => (
          <li
            key={index}

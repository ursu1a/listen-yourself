...
export const Main = () => {
  ...
  return (
    <section className="relative lg:py-2">
      <div className="flex items-center flex-col gap-y-4 lg:flex-row xl:mt-[180px]">
        <div className="lg:hidden -mt-[1.5rem]">{mainImage}</div>
        <div className="lg:pt-20 lg:w-1/2">
        ...
        <div className="hidden lg:block lg:absolute-0 right-0 top-0 w-full lg:w-1/2 lg:-mt-[13.75rem] xl:-ml-[6.5625rem]">
          {mainImage}
        </div>
      </div>
    </section>

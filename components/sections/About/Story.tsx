      ...
      <div className="lg:absolute z-10 inset-0">
        <div className={container({ className: "flex items-center h-full" })}>
          <div className="flex flex-col-reverse lg:flex-row gap-x-8 gap-y-3 lg:space-y-0 py-8">
            <div className="w-full lg:w-1/2 bg-white/40 py-6 px-6 space-y-3 text-slate-700">
              <p className={subtitle()}>{strings.about.story.subtitle}</p>
            ...
            <div className="w-full lg:w-1/2 bg-white/40 p-4 flex items-center justify-center">
              <Image
                alt="author"
                className="h-[300px]"
                radius="none"
